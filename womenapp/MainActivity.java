...
public class MainActivity extends AppCompatActivity implements SurfaceHolder.Callback {
    ...
    private Button sosButton, recordButton, chatBotButton, callButton;
    ...
    /**
     * Prepares the MediaRecorder for video capture.
     * Sets camera, audio, video sources, output file, and preview display.
     * @return true if MediaRecorder is successfully prepared, false otherwise.
     */
